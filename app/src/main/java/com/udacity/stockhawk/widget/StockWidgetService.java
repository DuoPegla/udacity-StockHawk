...
public class StockWidgetService extends RemoteViewsService
{
    ...
    private class StockWidgetViewFactory implements RemoteViewsFactory
    {
        ...
        private void getData()
        {
            ...
            try
            {
                ...
                while (cursor.moveToNext())
                {
                    ...
                    cv.put(Contract.Quote.COLUMN_ABSOLUTE_CHANGE, change);
        ...
        public RemoteViews getViewAt(int position)
        {
            ...
            float change = cv.getAsFloat(Contract.Quote.COLUMN_ABSOLUTE_CHANGE);
            float percentChange = cv.getAsFloat(Contract.Quote.COLUMN_PERCENTAGE_CHANGE);
            ...
            remoteViews.setTextViewText(R.id.change, percentageFormat.format(percentChange/100));
            ...
            remoteViews.setOnClickFillInIntent(R.id.quote_list_item, fillIntent);
